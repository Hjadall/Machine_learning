...
for model_name, model in classification_models.items():
    ...
    X_classification = earthquakes[['Latitude', 'Longitude','xM            The largest value among the given magnitude (MD, ML, Mw, Ms, Mb) values.','Depth']]
    ...
    model.fit(train_set_class[['Latitude', 'Longitude','xM            The largest value among the given magnitude (MD, ML, Mw, Ms, Mb) values.','Depth']], train_set_class['Region'])

    # Make predictions on the test set
    predictions = model.predict(test_set_class[['Latitude', 'Longitude','xM            The largest value among the given magnitude (MD, ML, Mw, Ms, Mb) values.','Depth']])
